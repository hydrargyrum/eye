...
class SearchReplaceWidget(QWidget, WidgetMixin):
	...
	def _search(self):
		...
		props = self.pattern_options.to_search_props()
		props.expr = pattern
	...
	def _replace(self):
		...
		editor.search_obj.replaceSelection(self.replace_edit.text(), is_re=props.isRe)
		self._search()
	...
	def _replace_all(self):
		...
		editor.search_obj.replaceAll(self.replace_edit.text(), is_re=props.is_re)
